...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    // Variante paginata per derived queries
    Page<User> findByNameContainingIgnoreCaseAndEmailEndingWithIgnoreCase(String name, String suffix, Pageable pageable);
    ...
    @Query(value = "select * from users u \n" +
                   ...
                   "and (:domain is null or u.email ilike '%@' || :domain)",
