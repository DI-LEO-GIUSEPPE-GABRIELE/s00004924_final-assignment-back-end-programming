...
public class AirportController {
    ...
    public AirportController(AirportRepository airports) { this.airports = airports; }

    @GetMapping
    public Page<Airport> list(Pageable pageable) { return airports.findAll(pageable); }
    ...
    public ResponseEntity<?> delete(@PathVariable UUID id) {
        if (!airports.existsById(id)) return ResponseEntity.notFound().build();
