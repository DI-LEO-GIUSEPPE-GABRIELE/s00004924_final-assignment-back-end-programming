...
public class TourOperatorController {
    ...
    public TourOperatorController(TourOperatorRepository operators) { this.operators = operators; }

    @GetMapping
    public Page<TourOperator> list(Pageable pageable) { return operators.findAll(pageable); }
