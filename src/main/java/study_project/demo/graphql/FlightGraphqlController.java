package study_project.demo.graphql;
...
public class FlightGraphqlController {
    ...
    public FlightGraphqlController(FlightRepository flights, ExchangeRateService rates) { this.flights = flights; this.rates = rates; }
